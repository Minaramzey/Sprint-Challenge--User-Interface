...
introduces meaning to the webpage

2. Name two big differences between ```display: block;``` and ```display: inline;```.
block: display in a block,take up all available width
inline: display inline, takes width but doesnt force new lines.
...
performance- its reliable
securiy- its designed o maintain he integriy of source code.
